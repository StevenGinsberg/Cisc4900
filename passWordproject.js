...
;
    ...
    function newvalues(){
     //refreshPage();
      ...
      passWords1[1]=("Ch46olate is yummy!");
      passWords1[2]=("1@342");
      passWords1[3]=("Joey1");
        ...
        questions[i].addEventListener("click", function(){
          ...
          //  var keycode=13;
           ...
           $("input").on(selectText());
            ...
            if(count==150){switchWithCondition(completed);
                   message1Display.textContent="Level Complete";}
             if(colorDisplay.textContent =="H4ppy B1rthday"){count+=10;
               message1Display.textContent="Good Password!!!";
               message4Display.textContent="It will take 2 billion years to break.";
              } 
        ...
        questions[i].addEventListener("click", function(){
          ...
          //  var keycode=13;
            var text=$(this).text();
             ...
             var completed=true;
           $("input").on(selectText());
                if(count==150){message1Display.textContent=renderTime.value;}
                if(count==150){switchWithCondition(completed);
                   message1Display.textContent="Level Complete";}
