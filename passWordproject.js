...
var numQuestions = 8;
var passWords1 =  ["I like cheesecake","1@342","Joey1","Physics","Y4NK33S"];
var pickedPasswords;
            ...
            if(count==150){message4Display.textContent="Level Complete";
             ...
             if(colorDisplay.textContent =="H4ppy B1rthday"){count+=10;
              ...
              if(colorDisplay.textContent =="Br00kly4"){count+=10;
               ...
               if(colorDisplay.textContent =="I like cheesecake"){count+=10;
                  message1Display.textContent="Great Password!!";
              ...
              if(colorDisplay.textContent =="Ch46olate"){count-=10;
                   message1Display.textContent="Bad Password!! ";
                   message4Display.textContent=" 2 weeks Length: Short Your password is quite short. The longer a password is the more secure it will be.Character Variety: No SymbolsYour password only contains numbers and letters. Adding a symbol can make your password more secure. Don't forget you can often use spaces in passwords.";
              }   
              if(colorDisplay.textContent =="1@342"){count-=10;
                   message1Display.textContent="Bad Password!!";
                   message4Display.textContent= "10 hundred microsecondsLength: Very shortYour password is very short. The longer a password is the more secure it will be.";
                 }   
